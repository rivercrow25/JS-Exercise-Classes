...
*/
//needs model and miles per gallon as params a tank and odometer that starts at 0, ability to be fueled give the ability to drive while gas is tank isnt empty
class Car {
  ...
  drive(distance) {
    ...
    if (this.tank >= distanceNeeded) {
      this.odometer = distance
      this.tank = this.tank - distanceNeeded
    } else {
